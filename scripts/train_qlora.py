...
from src.models.qlora_model import create_qlora_model
...
def train(config_path, model_name, data_path):
    ...
    trainer = Trainer(
        ...
        eval_dataset=tokenized_datasets, # Using same for demo
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="configs/training_configs/qlora_config.yaml")
